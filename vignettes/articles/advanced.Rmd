...
Load our model at: https://github.com/bbsBayes/bbsBayes2/tree/1cfe795a2706a5363ccf83ad593bcb8fe5509187/data by clicking the file HETA_bbs_usgs_gamye.rds, then clicking “Download” to the right.
...
#Or run a model with fewer chains and iterations:
...
bbsBayes2 also includes a function to help re-start an MCMC chain, so that you avoid having to wait for an additional burn-in period.
